...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    ...
    public class InternalEntityTypeBuilder : AnnotatableBuilder<EntityType, InternalModelBuilder>, IConventionEntityTypeBuilder
    {
            ...
            bool? required = null)
        {
            ...
            var existingRelationship = InternalForeignKeyBuilder.FindCurrentRelationshipBuilder(
                targetEntityType,
                Metadata,
                navigationToTarget,
                inverseNavigation,
            ...
            {
                existingRelationship = InternalForeignKeyBuilder.FindCurrentRelationshipBuilder(
                    Metadata,
                    targetEntityType,
                    inverseNavigation,
                    navigationToTarget,
